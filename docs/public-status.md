...
an installation offer for missing Microsoft build tools. Its corrected upload
also fixes swimsuits, such as Diamond, whose fabric did not render (#62).
It does not expand the play-test coverage below.
